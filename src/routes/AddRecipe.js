...
export default function AddRecipe() {
  ...
  const handleSignUp = async () => {
    ...
    if (response.error) {
      ...
      setIsSignedIn(true);
      setShowEmailVerificationMessage(true); // Show email verification message
      setTimeout(() => {
        setShowEmailVerificationMessage(false); // Hide message after a delay
  ...
  // Function to display email verification message
